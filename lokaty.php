...
<?php
        ...
        $Query = "SELECT * FROM inwestycje WHERE id_typ=1 AND Wykupione=0";
		$Result = $Connection->query($Query);
        echo "<center><h1>Lokaty</h1></center>";
        ...
        <td><input type='text' value='$Row[1]' name='Nazwa Inwestycji' class='form-control' readonly='readonly'/>";
        if($Row[5]!=null)
        {
         echo "Oprocentowanie: $Row[5] %";
        }
        echo "</td>
